...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getFullDomainWithProtocol: function getFullDomainWithProtocol() {
      var protocol = window.location.protocol;
      var hostname = window.location.hostname;
      var port = window.location.port ? ':' + window.location.port : '';
      this.domain = "".concat(protocol, "//").concat(hostname).concat(port);
    }
  },
  computed: {
    ...
    hasNoImages: function hasNoImages() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _this.getFullDomainWithProtocol();
            _this.preparePreviewImage();
            _this.field.fill = function (formData) {
              var attribute = _this.field.attribute;
              if (_this.field.multiple) {
                var fieldJSON = function fieldJSON() {
                  try {
                    JSON.parse(_this.currentField.value);
                    return true;
                  } catch (e) {
                    return false;
                  }
                };
                if (_this.currentField.value && fieldJSON()) {
                  // Parse existing images
                  var existingImages = JSON.parse(_this.currentField.value);
                  // Create a string with a list of existing image URLs separated by commas
                  var existingImagesString = existingImages.join(',');
            ...
            setTimeout(function () {
              _this.$nextTick(function () {
                var el = _this.$refs.imageList;
                if (el) {
                  sortablejs__WEBPACK_IMPORTED_MODULE_1__["default"].create(el);
                  el.addEventListener('update', _this.handleSortableUpdate);
                }
              });
            }, 500);
          case 4:
  ...
  methods: {
    ...
    handleSortableUpdate: function handleSortableUpdate(event) {
      var newOrder = Object.values(event.target.children).map(function (item) {
    ...
    convertWebPToPNG: function convertWebPToPNG(blob) {
    ...
    fetchPreviewImage: function fetchPreviewImage() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var jsonImage, response, data;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              if (_this2.field.multiple) {
                jsonImage = JSON.parse(_this2.currentField.value);
                _this2.imageForPreview = _this2.domain + jsonImage[0];
              } else {
                _this2.imageForPreview = _this2.domain + _this2.currentField.value;
              }
              _context2.next = 3;
              return fetch(_this2.imageForPreview);
            case 3:
            ...
            case 6:
              data = _context2.sent;
              fetch(_this2.imageForPreview).then(function (response) {
                return response.blob();
              }).then(function (data) {
                if (data.type === 'image/webp') {
                  return _this2.convertWebPToPNG(data).then(function (imageDataURL) {
                    return fetch(imageDataURL);
                  }).then(function (response) {
                    return response.blob();
                  }).then(function (imageData) {
                    var convertedFile = new File([imageData], _this2.imageForPreview, {
                      type: imageData.type
                    });
                    _this2.previewFile = createFile(convertedFile);
                  });
                } else {
                  _this2.previewFile = createFile(new File([data], _this2.imageForPreview, {
                    type: data.type
                  }));
                }
    ...
    confirmRemoval: function confirmRemoval(index) {
      var images_delete = JSON.parse(this.currentField.value);
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 7:
              ...
              Nova.success(_this3.__('The image was deleted!'));
              _context3.next = 17;
              break;
            case 13:
              _context3.prev = 13;
  ...
  computed: {
    ...
    labelFor: function labelFor() {
      ...
      return "imagic-".concat(name, "-").concat(this.field.attribute);
    },
    /**
...
var _hoisted_1 = {
  "class": "gallery d-flex flex-wrap"
};
var _hoisted_2 = {
  key: 0,
  "class": "break-words"
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_PanelItem, {
    index: $props.index,
    field: $props.field
  }, {
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.imageUrls, function (image, imageIndex) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_ImageLoader, {
          key: imageIndex,
          src: image,
          maxWidth: 150,
          style: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeStyle)({
            zIndex: $options.imageUrls.length - imageIndex,
            marginRight: '-15px'
          })
        }, null, 8 /* PROPS */, ["src", "style"]);
      }), 128 /* KEYED_FRAGMENT */))]), $options.hasNoImages ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_2, "—")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $options.shouldShowToolbar ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_3, [$props.field.downloadable ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
        key: 0,
        ...
        width: "16",
        height: "16"
      }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__('Download')), 1 /* TEXT */)], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_4)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)];
    }),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["index", "field"])]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      var _ctx$file, _ctx$file2;
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Existing Image "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [$options.hasValue || _ctx.previewFile ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_2, [!_ctx.field.multiple ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [_ctx.previewFile && !_ctx.field.multiple ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_FilePreviewBlock, {
        key: 0,
        file: _ctx.previewFile,
        removable: false,
        rounded: _ctx.field.rounded,
        dusk: _ctx.field.attribute + '-delete-link'
      }, null, 8 /* PROPS */, ["file", "rounded", "dusk"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _ctx.field.multiple ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        key: 1
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(JSON.parse(_ctx.currentField.value), function (path, index) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: path
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Remove Button "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_RemoveButton, {
          "class": "absolute z-20 top-[-10px] right-[-9px]",
          onClick: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
            return $options.confirmRemoval(index);
          }, ["stop"]),
          dusk: _ctx.currentField.attribute + '-delete-link'
        }, null, 8 /* PROPS */, ["onClick", "dusk"]), [[_directive_tooltip, _ctx.__('Remove')]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Image Preview "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
          src: _ctx.domain + path,
          "class": "aspect-square object-scale-down"
        }, null, 8 /* PROPS */, _hoisted_7)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" File Information "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
          title: path,
          "class": "multi_title font-semibold text-xs mt-1"
        }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(path), 9 /* TEXT, PROPS */, _hoisted_8)])])]);
      }), 128 /* KEYED_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 512 /* NEED_PATCH */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" DropZone "), !_ctx.field.multiple ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DropZone, {
        key: 1,
      ...
      }, null, 8 /* PROPS */, ["onChange", "onFileChanged", "files", "onFileRemoved", "rounded", "accepted-types", "disabled", "dusk", "input-dusk"])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DropZone, {
        key: 2,
        onChange: $options.handleFileChange,
        onFileChanged: $options.handleFileChange,
        files: _ctx.images,
        ...
        rounded: _ctx.field.rounded,
        "accepted-types": _ctx.field.acceptedTypes,
        disabled: (_ctx$file2 = _ctx.file) === null || _ctx$file2 === void 0 ? void 0 : _ctx$file2.processing,
        dusk: _ctx.field.attribute + '-delete-link',
        "input-dusk": _ctx.field.attribute,
        multiple: "",
        ref: _ctx.dropzone
      }, null, 8 /* PROPS */, ["onChange", "onFileChanged", "files", "onFileRemoved", "rounded", "accepted-types", "disabled", "dusk", "input-dusk"]))])];
    }),
    _: 1 /* STABLE */
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_ImageLoader = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("ImageLoader");
  var _component_Icon = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("Icon");
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.imageUrls, function (image, imageIndex) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_ImageLoader, {
      key: imageIndex,
      src: image,
      maxWidth: 150,
    ...
    width: "16",
    height: "16"
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__('Download')), 1 /* TEXT */)], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_4)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 64 /* STABLE_FRAGMENT */);
}
...
Nova.booting(function (app, store) {
  app.component('index-gallery', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-gallery', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-gallery', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var C_OSPanel_domains_CheckPackages_nova_components_Gallery_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjavadle_gallery"] = self["webpackChunkjavadle_gallery"] || [];
